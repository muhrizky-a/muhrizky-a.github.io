...
submit.addEventListener("click", () => {
    ...
    // iframe.src = `https://www.youtube.com/embed/${input.value}`;
    ...
    // iframe.src = `https://www.youtube.com/embed/${input.value}?controls=controls=2&enablejsapi=1&fs=1&iv_load_policy=3&modestbranding=1&rel=0&playsInline=0&origin=https%3A%2F%2Fgenius.com&start=0`;
    input.value = "";
});